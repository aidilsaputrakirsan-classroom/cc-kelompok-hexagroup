...
export default function AdminPanel({ user, showToast }) {
  ...
  const styles = {
    ...
    modalOverlay: { position: "fixed", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 1050, padding: "16px", overflowY: "auto" },
